package sv.edu.ufg.fis.amb.almacenamientointernoyexterno_pb100221
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        escrituraArchivosAlmacenamientoExterno(this,"archivo_almacenamiento_externo.txt", "ESTE ES UN CONTENIDO EN EL ALMACENAMIENTO EXTERNO")
